      ...
      >
        <Paper elevation={3} sx={{ width: 600, m: 'auto', mt: '10%', p: 2 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', p: 1, bgcolor: 'grey.100' }}>
            <Typography variant="subtitle1" id="email-composer-title">New Message</Typography>
            <Box>
              <IconButton size="small"><MinimizeIcon /></IconButton>
...
{attachments.length > 0 && (
          ...
          <Divider />
          <Box sx={{ display: 'flex', alignItems: 'center', p: 1, bgcolor: 'grey.100' }}>
            <Button onClick={()=>send_mail()} variant="contained" color="primary" sx={{ mr: 1 }}>Send</Button>
            <IconButton size="small"><AttachFile /></IconButton>
            <IconButton size="small"><InsertLink /></IconButton>
            <IconButton size="small"><EmojiEmotions /></IconButton>
            <IconButton size="small"><ArrowDropUp /></IconButton>
            <IconButton size="small"><EventNote /></IconButton>
            <IconButton size="small"><LockOutlined /></IconButton>
